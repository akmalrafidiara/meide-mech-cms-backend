...
namespace App\Modules\Carousel\Controllers;

use App\Modules\Carousel\Models\CarouselModel;
...
class Carousel extends BaseController
{
    ...
    public function index()
    {
        $data = [
            ...
            'data' => $this->carouselModel->findAll(),
        ];
    ...
    {
        $data = $this->carouselModel->where(['status' => '1'])->findAll();
