<main>
  <div class="container-fluid px-4">
    <h1 class="mt-4">Edit Partners</h1>
    <ol class="breadcrumb mb-4">
      <li class="breadcrumb-item">Data Partners</li>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="/admin/partners/<?= $data['id'] ?>" method="post" enctype="multipart/form-data">
          <?= csrf_field() ?>
            ...
            <div class="col-6">
              <div class="mb-3">
                <div class="row d-flex align-items-center">
                  ...
                  <div class="col-6">
                    <img src="/img/<?= $data['images'] ?>" alt="" style="width: 150px;" id="imgPreview">
                  </div>
                </div>
              </div>
              <div class="mb-3">
                ...
                <input type="text" class="form-control  <?= ($validation->hasError('link')) ? 'is-invalid' : '' ?>"
                  id=" link" placeholder="your link" name="link" value="<?= old('link', $data['link']) ?>">
                <div class="invalid-feedback">
